                ...
                <section id="urlbox" class="w-full">
                    <div class="bg-white shadow-lg rounded px-8 mb-4 flex flex-col h-[270px] items-center justify-center">
                        <div class="flex w-[620px]">
                            <input id="urlInput" class="shadow appearance-none border rounded-l w-full h-[58px] py-2 px-3 text-gray-700 leading-tight" value="{{$short_url}}" id="url" name="url" type="text" placeholder="Enter the url text here..." required>
                        ...
                        <div class="max-w-[620px] mt-[10px] mx-auto text-left w-full">
                            <p class="mb-2">Long URL : 
                                <a class="text-blue-600 hover:text-blue-900" target="_blank" href="{{$link->url}}">{{$link->url}}</a>
                            </p>
